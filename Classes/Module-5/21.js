...
class Car {
  constructor(doors, windows, motor, tires) {
    this.doors = doors;
...
class Mazda extends Car {
  constructor(doors, windows, motor, tires, model) {
    super(doors, windows, motor, tires);
    this.model = model;
  }

  get greeting() {
    return `This is ${this.model} car`;
  }
}

const carTemplate = new Car(5, 4, 'Gas', 4);
const mazda3 = new Mazda(5, 4, 'Gas', 4, 'Mazda 3');

console.log(mazda3.greeting);
